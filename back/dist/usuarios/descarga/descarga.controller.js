...
const descarga_service_1 = require("./descarga.service");
let DescargaController = class DescargaController {
    constructor(descarga) {
        this.descarga = descarga;
    }
    async getPdf(res, filename, id_user, id_libro) {
        try {
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('id_libro')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, Object, Object]),
    __metadata("design:returntype", Promise)
], DescargaController.prototype, "getPdf", null);
